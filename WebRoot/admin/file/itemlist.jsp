...
%>
      ...
      <div class="" style="line-height:1.5;width:300px;margin:auto;margin-top:15px;">
      	<a href="itemlist.jsp?classify=<%=classify %>&page=1">首页</a>
<%if(intPage>1){
%>
<a href="itemlist.jsp?classify=<%=classify %>&page=<%=intPage-1%>">上一页</a>
<%}%>
<%if(intPage<intPageCount)
{%>
<a href="itemlist.jsp?classify=<%=classify %>&page=<%=intPage+1%>">下一页</a>
<%}%>
<a href="itemlist.jsp?classify=<%=classify %>&page=<%=intPageCount%>">尾 页</a>
