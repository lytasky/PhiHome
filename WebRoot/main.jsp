...
<FORM name=CLD>
<div align="center">
<table width="780" border="0" cellspacing="0" cellpadding="0" bgcolor="EEF2FD">
...
<center>
 ...
 <tr>
  ...
  <CENTER>
        <table width="100%" height="1" bordercolordark="#FFFFCC">
        <tr>
          <td width="100%" height="1"><font style="font-size:10.8pt" color=#0> 　&nbsp;
            用<font color=blue>[月↑][月↓]</font>翻动可以找到你想要的确切日期。</font></td>
        </tr>
      </table>
      </CENTER>
      </table>
    ...
    <TD align=middle width="423" height="255">
      ...
      <div align="center">
      <center>
      <TABLE  height="27" cellspacing="1">
        <TBODY>
        <TR bgcolor="#D3E3F5">
          <TD height="24" colSpan=7 align="center"><FONT color=#000080 size=2
