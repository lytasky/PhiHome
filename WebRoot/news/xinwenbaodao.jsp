...
<%
	...
	News tzgg = newsMgr.getById("xinwenbaodao", id) ;
	String title = tzgg.getTitle();
	String newsFrom = tzgg.getNewsfrom();
	String publishTime = tzgg.getPublishtime();
	String content = tzgg.getContent();
 %>
<!doctype html>
<html lang="en">
<head>
	...
	<div id="main-content" class="gray-border" style="margin-top:50px;margin-left:58px;width:1065px;padding-bottom:15px;height:auto;">
     ...
     <div class="panel-group" id="accordion" style=""><!--网站地图-->
    	...
    	<div class="gray-border round-border" style="width:840px;height:auto;background-color:#FFF;margin-top:15px;padding-top:15px;">
  		<div align="center" style="line-height:1.5;font-size:20px;font-weight:bold;"><%= title %></div>
      <div style="border-bottom:1px dashed #999;line-height:1.5;" align="center">发布时间：<%=publishTime %>  | 来源： <%=newsFrom %></div>
