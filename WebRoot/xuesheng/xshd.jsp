...
<%   
  ...
  //String classify="xshd";
  String sql = "select * from file where classify='xshd' order by id desc";    //执行SQL语句
...
%>
      ...
      <div class="" style="line-height:1.5;width:300px;margin:auto;margin-top:15px;">
      	<a href="xshd.jsp?classify='xshd'&page=1">首页</a>
<%if(intPage>1){
%>
<a href="xshd.jsp?classify='xshd'&page=<%=intPage-1%>">上一页</a>
<%}%>
<%if(intPage<intPageCount)
{%>
<a href="xshd.jsp?classify='xshd'&page=<%=intPage+1%>">下一页</a>
<%}%>
<a href="xshd.jsp?classify='xshd'&page=<%=intPageCount%>">尾 页</a>
