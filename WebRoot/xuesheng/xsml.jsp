...
<%   
  ...
  String sql = "select * from file where classify='xsml' order by id desc";    //执行SQL语句
...
%>
      ...
      <div class="" style="line-height:1.5;width:300px;margin:auto;margin-top:15px;">
      	<a href="xsml.jsp?classify='xsml'&page=1">首页</a>
<%if(intPage>1){
%>
<a href="xsml.jsp?classify='xsml'&page=<%=intPage-1%>">上一页</a>
<%}%>
<%if(intPage<intPageCount)
{%>
<a href="xsml.jsp?classify='xsml'&page=<%=intPage+1%>">下一页</a>
<%}%>
<a href="xsml.jsp?classify='xsml'&page=<%=intPageCount%>">尾 页</a>
