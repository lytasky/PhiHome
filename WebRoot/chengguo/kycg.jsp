...
<%   
  ...
  String sql = "select * from file where classify='kycg' order by id desc";    //执行SQL语句
...
%>
      ...
      <div class="" style="line-height:1.5;width:300px;margin:auto;margin-top:15px;">
      	<a href="kycg.jsp?classify='kycg'&page=1">首页</a>
<%if(intPage>1){
%>
<a href="kycg.jsp?classify='kycg'&page=<%=intPage-1%>">上一页</a>
<%}%>
<%if(intPage<intPageCount)
{%>
<a href="kycg.jsp?classify='kycg'&page=<%=intPage+1%>">下一页</a>
<%}%>
<a href="kycg.jsp?classify='kycg'&page=<%=intPageCount%>">尾 页</a>
