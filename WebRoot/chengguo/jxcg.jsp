...
<%   
  ...
  //String classify="jxcg";
  String sql = "select * from file where classify='jxcg' order by id desc";    //执行SQL语句
...
%>
      ...
      <div class="" style="line-height:1.5;width:300px;margin:auto;margin-top:15px;">
      	<a href="jxcg.jsp?classify='jxcg'&page=1">首页</a>
<%if(intPage>1){
%>
<a href="jxcg.jsp?classify='jxcg'&page=<%=intPage-1%>">上一页</a>
<%}%>
<%if(intPage<intPageCount)
{%>
<a href="jxcg.jsp?classify='jxcg'&page=<%=intPage+1%>">下一页</a>
<%}%>
<a href="jxcg.jsp?classify='jxcg'&page=<%=intPageCount%>">尾 页</a>
