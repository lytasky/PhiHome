...
<%   
  ...
  //String classify="zxqw";
  String sql = "select * from zxqw order by id desc";    //执行SQL语句
     ...
     <div class="panel-group" id="accordion" style=""><!--网站地图-->
  		<div class="panel panel-default">
    		<div class="panel-heading">
        		...
        		<a href="#"><span class="glyphicon glyphicon-th-list"></span> 闻人轶事</a>
      			</h4>
    		</div>
    		<div id="collapseOne" class="panel-collapse collapse in">
      			<div class="panel-body" style="display:block;">
        			<a href="../gushi/zxqw.jsp" style="color:#000;" class="panel-item">哲学趣闻</a>
      			</div>
      			<div class="panel-body">
        			<a href="../gushi/xygs.jsp" style="color:#000;" class="panel-item">校园故事</a>
      			</div>
            <div class="panel-body">
        			<a href="../gushi/xyfc.jsp" style="color:#000;" class="panel-item">校友风采</a>
      			</div>
    		</div>
  		</div> 
	   </div><!-- panel-group -->
		...
		<div class="round-border deep-blue" style="height:37px;padding-top:10px;padding-left:15px;"><!--当前位置-->
         ...
         <span style="color:#fff;">->闻人轶事</span>	
      <span style="color:#fff;">->哲学趣闻</span>	
		</div>
...
%>
      <div class="" style="height:25px;line-height:1.5;border-bottom:1px dashed #d3d7da;">
      	<div class="" style="width:500px;float:left;margin-left:25px;letter-spacing:2px;"><a href="../admin/news/jtxx.jsp?classify=zxqw&id=<%=result.getString("id")%>" style="color:#000;"><%=result.getString("title")%></a></div>
...
%>
      ...
      <div class="" style="line-height:1.5;width:300px;margin:auto;margin-top:15px;">
      	<a href="zxqw.jsp?classify='zxqw'&page=1">首页</a>
<%if(intPage>1){
%>
<a href="zxqw.jsp?classify='zxqw'&page=<%=intPage-1%>">上一页</a>
<%}%>
<%if(intPage<intPageCount)
{%>
<a href="zxqw.jsp?classify='zxqw'&page=<%=intPage+1%>">下一页</a>
<%}%>
<a href="zxqw.jsp?classify='zxqw'&page=<%=intPageCount%>">尾 页</a>
