					...
					<tr valign="top">
						<td>
							...
							<span class="nobreak"><span class="jive-paginator">
									<a href="userMrg.jsp?pageNo=1">第一页</a>
							</span>
							</span>
							...
							<span class="nobreak"><span class="jive-paginator">
									<a href="userMrg.jsp?pageNo=<%=pageNo - 1%>">上一页</a> </span>
							</span>
							...
							<span class="nobreak"><span class="jive-paginator">
									<a href="userMrg.jsp?pageNo=<%=pageNo + 1%>">下一页</a>
									|&nbsp; <a href="userMrg.jsp?pageNo=<%=totalPages%>">最末页</a>
									] </span> </span>
						</td>
					</tr>
				</tbody>
